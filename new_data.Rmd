...
For the exposure predictor `new_tpn_status`, the p-value 0.2743 is greater than 0.05 which indicates that it is not statistically significant. Our model suggests that having total parental nutrition does not significantly impact the result of blood culture positive. The Odds Ratio of having TPN to BCP is eβ = e^-0.5393 = 1.715.
