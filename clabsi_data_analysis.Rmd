...
Great, we found `r nrow(join_test2)` observations of patients who have blood culture positive within the 14-day period of central line inserted. 

Incidence of bcp in central lined patients are `r nrow(join_test2)` / `r nrow(test2)`.
